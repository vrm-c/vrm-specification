...
- [ExpressionPreset(enum)](#expressionpresetenum)
  - [Emotions (enum)](#emotions-enum)
  - [Lip Sync (enum) Procedural](#lip-sync-enum-procedural)
  - [Blink (enum) procedural](#blink-enum-procedural)
  - [gaze (enum) procedural](#gaze-enum-procedural)
  - [Other (enum)](#other-enum)
  - [User-defined (enum)](#user-defined-enum)
...
| Name                                   | Remarks                                                                                                       |
|:---------------------------------------|:--------------------------------------------------------------------------------------------------------------|
| expressions [*] .preset                | Follow these constraints to uniquely identify the above Expressions                                           |
| expressions [*] .name                  | Follow these constraints to uniquely identify the above Expressions                                           |
...
Follow the constraints below to uniquely identify each Expression

When preset is other than custom

* Do not duplicate preset
* Make name an empty string

When preset is custom

* preset custom may be duplicated
* Do not duplicate name
...
| Name   | Remarks                                                                                                           |
|:-------|:------------------------------------------------------------------------------------------------------------------|
| custom | Use this when you want to use an Expression that the Application has decided on its own. Please identify by name. |
